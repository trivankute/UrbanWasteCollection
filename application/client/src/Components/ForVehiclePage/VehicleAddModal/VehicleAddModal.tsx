                                ...
                                <div className="p-6 space-y-6">
                                    <div className="w-full h-fit p-4 pt-0 flex items-center justify-between">
                                        ...
                                        <div className="flex-1 h-full flex flex-col justify-center items-start gap-y-2 ">
                                            ...
                                            <span className="text-sm font-normal flex">NumberPlate
                                            <input type="text" className="border-1 ml-2 border-black p-1 rounded-xl" />
                                            </span>
                                            <button className="w-20 h-fit p-2 rounded-xl mt-2 bg-green-400 text-sm text-white flex justify-center items-center">+ Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
