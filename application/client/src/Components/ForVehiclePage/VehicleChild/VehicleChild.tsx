...
function VehicleChild({data=null}:{data?:any}) {
    ...
    return ( <>
        <div onClick={()=>{
            ...
            <div className="flex flex-col gap-y-2 items-center">
                <span className="text-sm font-semibold flex justify-start">TaskId: {data.task.id?(data.task.id.substring(0,4)+"..."):"None"}</span>
            </div>
